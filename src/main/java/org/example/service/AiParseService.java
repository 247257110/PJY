...
public class AiParseService {
    ...
    private static final String PROMPT_ATTENDANCE = """
            ...
            - 单元格内有明确的签到标记（如打钩 ✓、✔、√、”√”、汉字”有”、数字或其他清晰可见的手写/印刷符号）→ “有”；单元格为空白、仅有格线/阴影/水印/轻微噪点 → “无”
    ...
    private static final String PROMPT_FULL = """
            ...
            2. attendances 来自”合作公司人员考勤登记表”，提取规则如下：
               ...
               - morning：时间列上午单元格有明确签到标记（如打钩 ✓、✔、√、”√”、汉字”有”、数字或其他清晰可见手写/印刷符号）→ “有”；单元格为空白、仅有格线/阴影/水印/轻微噪点 → “无”
               - afternoon：时间列下午单元格有明确签到标记（如打钩 ✓、✔、√、”√”、汉字”有”、数字或其他清晰可见手写/印刷符号）→ “有”；单元格为空白、仅有格线/阴影/水印/轻微噪点 → “无”
               - 判断标准：必须是人为填写的清晰标记，不得将空白格、格线交叉阴影、水印、扫描噪点误判为”有”
